...
ext.WriteJSON = function(path) {
	var filestring = JSON.stringify(jsonobject);
	fs.writeFileSync(filepath, filestring, {encoding:'utf-8'});
}
ext.SetExitCommand = function(command) {
	var exitCommandPath = '/Users/njbleaux/Repos/bow/redo/exitcommand.sh';
